 ...
 * Use the [Adicionales.newInstance] factory method to
 * create an instance of this fragment.
 */
class Adicionales : Fragment() {
    ...
    override fun onCreateView(
       ...
       val view: View =
           inflater.inflate(R.layout.fragment_adicionales,container,false)
        ...
        btnOperaciones.setOnClickListener({
            ...
            transaccion.replace(R.id.contenedor_af,operaciones)
            transaccion.commit()
        })
    ...
    companion object {
         ...
         * @return A new instance of fragment Adicionales.
         */
